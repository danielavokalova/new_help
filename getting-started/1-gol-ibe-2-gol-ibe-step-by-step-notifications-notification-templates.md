...
* **EDIT** - here you may modify the way your notification looks like. You may edit text, change colours, insert logo etc.
* **DELIVERY** - here you may specify what users should receive that specific notification.
...
* **Air tickets - Booking canceled** - anytime booking is canceled confirmation goes to the client.
* **Air tickets - Ticket issued** - confirmation including flight ticket.
* **Payments - Booking paid** - in case there is payment via credit card available for your client in such case and payment for booking is succesful this informaton goes to the client.
...
While modifying your template this way 

* Choose an area in your template where you want to have your logo.
* Copy (CTRL + C) your logo from your source.
* Paste (CTRL + V) your logo in your template.

Logo gets there this way.

Save changes.

**3 b) Editation via HTML** 
...
This way you can manage any notification delivery.

**Recipients  - EXPLANATION**

* **to customer** - person that makes a booking / traveler
* **to passengers** - traveler in Trip Gate - this recepient is not for GOL IBE
* **to dealer** - agency in the role of dealer
* **to agency** - owner of an account in GOL IBE
* **to configurator** - system provider (it is us) 

further settings

* send itinerary - to manage attachments that are attached to certain notifications.
